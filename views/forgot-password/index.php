        ...
        <div class="main-panel offset-md-4 col-md-4">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="p-3">
                        <h5 class="text-white text-center pt-3">Trouble Logging In?</h5>
                        <p class="text-white text-center mb-5">Enter your email and we'll send you a link to get back into your account.</p>
                        ...
                        <?php $form = ActiveForm::begin([
                            ...
                            <div class="text-input-wrapper mb-3">
                            ...
                            <div class="form-group row mb-5">
                                <div class="col-sm-12 text-right">
                                    <button class="btn col-md-12 text-uppercase" type="submit"><?= Yii::t('app', 'submit') ?></button>
                                </div>
                            </div>

                            <div class="form-group row forgot-link">
                                <div class="col-12 text-white text-center font-bold text-uppercase">
